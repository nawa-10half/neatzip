...
run(label: "many-small default", src: small, info: smallInfo, options: CleanZipOptions(compressionLevel: -1))
run(label: "large-text default",  src: large, info: largeInfo, options: CleanZipOptions(compressionLevel: -1))
run(label: "large-text AES-256",  src: large, info: largeInfo, options: CleanZipOptions(password: "p", encryption: .aes256, compressionLevel: -1))
run(label: "incompress default",  src: rnd, info: rndInfo, options: CleanZipOptions(compressionLevel: -1))
